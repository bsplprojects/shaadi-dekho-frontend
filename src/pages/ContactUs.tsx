      ...
      <div className="container max-w-5xl relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Have a question or need assistance? We're here to help you on your
            journey to finding the perfect partner.
          </p>
        </div>
            ...
            {[
              {
                icon: Mail,
                title: "Email Us",
                detail: "support@ShaadiDekho.com",
              ...
              },
              {
                icon: MapPin,
                title: "Visit Us",
                detail: "Tower B, Cyber City",
                sub: "Gurugram, Haryana 122002",
              },
              {
                icon: Clock,
                title: "Working Hours",
